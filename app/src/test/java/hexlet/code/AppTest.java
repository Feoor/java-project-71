...
class AppTest {
    ...
    @Test
    void testGetJsonDataWithValidFile() throws Exception {
        // Arrange
        ...
        assertEquals("hexlet.io", result.get("host"), "Key 'host' should have the correct associated value");
        assertEquals(false, result.get("follow"), "Key 'follow' should have the correct associated value");
    }

    @Test
    void testGetJsonDataWithEmptyJsonFile() throws Exception {
        // Arrange
